...
import { sidebarGroups } from "@/common/constants/navigation.constant";
...
export const AppSidebar = () => {
  ...
  return (
    <Sidebar className="bg-white dark:bg-gray-950 border-r border-gray-200 dark:border-gray-800 shadow-lg">
      <SidebarHeader className="py-4 text-center px-6 text-2xl font-bold text-primary-600 dark:text-primary-400 border-b border-gray-200 dark:border-gray-800">
        Kaset
      </SidebarHeader>
